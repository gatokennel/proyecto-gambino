    ...
    return (
        ...
        className='w-full h-screen md:min-h-[80vh] md:mt-[100px] bg-no-repeat bg-cover bg-center'>
            ...
            <div className='h-screen md:min-h-[80vh] w-full flex flex-col justify-center items-center backdrop-brightness-50  '>
                ...
                src={gambino} 
                alt="logo">
                </img><h1 className='md:hidden border-solid border-white border-4 rounded-2xl 2xl h-min w-min text-white text-center text-3xl p-2'>TIENDA</h1>
                <div className='hidden md:block border-solid border-white border-4 rounded-2xl h-min w-min'>
                        <h1 className="text-white text-center text-[10vw] md:text-9xl font-[Segoe UI] font-black p-6 pb-2 md:p-8 ">TIENDA</h1>
                        <h2 className="text-white text-center text-[3vw] md:text-2xl  font-[Fira Sans] font-light tracking-widest decoration-3 p-8 pt-0">GAMBINO</h2>
                </div>
            </div>
        </div>
    )
