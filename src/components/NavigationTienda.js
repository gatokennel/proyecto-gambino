...
const NavigationTienda = () => {
    ...
    return (
        <nav className="hidden md:flex md:fixed min-h-[15vh] z-50 top-0 left-0 right-0 flex items-center justify-between flex-wrap bg-black">
            ...
            <button><Link to="/tienda" spy={true} smooth={true} offset={-50} duration={500}  className={NAV_ITEM} onClick={closeMenu}><img className="object-cover ml-4 rounded-full"
                    width="100"
                    height="100"
                    src={gambino}
                    alt="logo">
...
export default NavigationTienda